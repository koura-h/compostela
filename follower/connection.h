...
int sc_aggregator_connection_send_message(sc_aggregator_connection_ref conn, sc_message* msg);
int sc_aggregator_connection_receive_message(sc_aggregator_connection_ref conn, sc_message** pmsg);
